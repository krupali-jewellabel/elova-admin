...
export default function TicketList({
  ...
  const filteredTickets = useMemo(() => {
    return allTickets.filter((ticket) => {
      ...
      const matchesDepartment =
        ...
        (departmentFilter === "unassigned" && !ticket.assignedTo) ||
        (departmentFilter === "mine" &&
          ticket.assignedTo?.id === currentUserId) ||
        normalize(ticket.department) === departmentFilter;
  ...
  }, [allTickets, searchQuery, departmentFilter, statusFilter, currentUserId]);
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2 flex-wrap text-xs">
                  ...
                  {ticket.assignmentHistory?.some((h) => h.isAutoAssigned) && (
