...
import { Avatar, AvatarFallback, AvatarImage, AvatarIndicator, AvatarStatus } from "@/components/common/ui/avatar";
import { Button } from "@/components/common/ui/button";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuPortal, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger } from "@/components/common/ui/dropdown-menu";
import { Input } from "@/components/common/ui/input";
import { CardContent, CardTitle } from "@/components/common/ui/cards/card";

// import { Sheet, SheetBody, SheetContent, SheetFooter, SheetHeader, SheetTitle } from "@/components/common/ui/sheet";
    ...
    return (
        <div className="bg-white rounded-xl shadow-md border border-border w-full flex flex-col h-[600px]">
            ...
            <div className="flex items-center gap-2 px-3 py-2 border-b border-border bg-accent/50">
                ...
                />
                <span className="text-xs italic text-muted-foreground block ml-2">Jessy is typing...</span>
            </div>
            {/* Messages */}
